...
public class NotificationPublisher extends BroadcastReceiver {
  ...
  private Notification getNotification(Context context, String contactName, String phoneNumber,
    ...
    PendingIntent cancelPending =
        PendingIntent.getBroadcast(context, 3, cancelIntent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    PendingIntent callPending =
        PendingIntent.getBroadcast(context, 3, callIntent, PendingIntent.FLAG_UPDATE_CURRENT);
