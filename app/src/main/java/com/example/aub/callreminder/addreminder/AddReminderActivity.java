...
public class AddReminderActivity extends FragmentActivity
  ...
  @Override public void onTimeSet(int hourOfDay, int minute) {
    mAddReminderViewModel.setHour(hourOfDay);
    mAddReminderViewModel.setMinute(minute);
    String time =
        getString(R.string.time_displayed, String.valueOf(hourOfDay), String.valueOf(minute));
  ...
  @OnClick(R.id.btn_from_contact) public void retrieveContactInfo(View v) {
