...
public class AddReminderActivity extends FragmentActivity
        implements onTimePickerListener, onDatePickerListener {

    public static final int REQUEST_CODE = 113;
    private static final String TAG = "AddReminderActivity";

    @BindView(R.id.et_contact_name)
    TextInputEditText mContactNameET;
    @BindView(R.id.et_contact_phone_number)
    TextInputEditText mContactPhoneNumberET;
    @BindView(R.id.et_reminder_reason)
    TextInputEditText mReminderReasonET;
    ...
    private ReminderViewModelFactory reminderViewModelFactory;
    ...
    private void setupViewModel() {
        reminderViewModelFactory = Injection.provideViewModelFactory(this);
        mAddReminderViewModel = ViewModelProviders.of(this, reminderViewModelFactory).get(
                AddReminderViewModel.class);
    ...
    public void onTimeSet(int hourOfDay, int minute) {
        ...
        String time =
                getString(R.string.time_displayed, String.valueOf(hourOfDay),
    ...
    public void onDateSet(int year, int month, int day) {
        ...
        String date = getString(R.string.date_displayed, String.valueOf(day),
