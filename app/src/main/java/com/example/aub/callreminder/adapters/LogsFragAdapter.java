...
public class LogsFragAdapter extends Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mTvLogDateTime.setText(
                DateTimeConverter.getFormattedDateTime(currentContact.getReminderTime()));
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.tv_log_contact_name)
        TextView mTvLogContactName;
        @BindView(R.id.tv_log_phone_number)
        TextView mTvLogPhoneNumber;
        @BindView(R.id.tv_log_date_time)
        TextView mTvLogDateTime;
        @BindView(R.id.tv_log_reminder_reason)
        TextView mTvLogReminderReason;
        @BindView(R.id.delete_btn)
        Button mDeleteBtn;
        @BindView(R.id.log_card_view)
        CardView mLogCardView;
