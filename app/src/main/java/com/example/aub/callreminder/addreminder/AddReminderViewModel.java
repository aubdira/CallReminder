...
public class AddReminderViewModel extends AndroidViewModel {
        ...
        try {
            ...
            if (cursor != null) {
                ...
                Cursor phoneCursor = resolver
                        .query(Phone.CONTENT_URI, null, Phone.CONTACT_ID + " = ?", new String[]{id}, null);
                if (phoneCursor != null) {
    ...
    void addContact() {
        Contact contact = new Contact(mContactName, mContactPhoneNumber, getTimeInMillis(), mReminderReason);
        mContactRepository.insertContact(contact).observeOn(AndroidSchedulers.mainThread())
    ...
    void notifyMe() {
        ...
        PendingIntent pendingIntent = PendingIntent
                .getBroadcast(mContext, (int) getTimeInMillis(), intent, PendingIntent.FLAG_UPDATE_CURRENT);
